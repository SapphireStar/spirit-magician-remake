...
namespace Framework
{
    public interface IBattleModel : IModel
    {
        ...
        Google.Protobuf.Collections.RepeatedField<PlayerBattleInfo> playerBattleInfos { get; set; }
        [Obsolete("playerBattleInfos")]
        PlayerBattleInfo playerBattleInfo { get; set; }
        [Obsolete("playerBattleInfos")]
        PlayerBattleInfo enemyBattleInfo { get; set; }
        BindableProperty<int> PlayerHP { get; set; }
        BindableProperty<int> EnemyHP { get; set; }
    ...
    public class BattleModel:AbstractModel,IBattleModel
    {
        ...
        public Google.Protobuf.Collections.RepeatedField<PlayerBattleInfo> playerBattleInfos { get; set; } = new Google.Protobuf.Collections.RepeatedField<PlayerBattleInfo>();
        ...
        public BindableProperty<int> PlayerHP { get; set; } = new BindableProperty<int>();

        public BindableProperty<int> EnemyHP { get; set; } = new BindableProperty<int>();
        ...
        public float countDown { get; set; } = 10;
        ...
        protected override void OnInit()
        {
            ...
            playerCarriedSkill.CarriedSkills.Add(new Google.Protobuf.Collections.RepeatedField<SkillEffect>() 
            {
                ...
                new SkillEffect(){SkillID = "ElfIce02"},
